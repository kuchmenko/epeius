...
Usage:
  ...
  bun run terminal -- prepare|execute --chain KEY (--quote-id ID | --preparation-id ID) (--route-id ID | --allocations JSON) --keystore PATH --password-file PATH [--slippage-bps N] [--confirm-approval yes | --confirm-swap yes] [--config PATH]
