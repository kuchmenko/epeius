...
Atomic V1 uses either one explicit returned one- or two-pool Uniswap V3 route, or two explicit returned direct Uniswap V3 routes, with a separately configured ExecutorV2:
