...
func TestBunConnectTransport(t *testing.T) {
	...
	path, actual := quotev1connect.NewQuoteServiceHandler(Handler{Chains: map[string]Chain{"base": {ChainID: "8453", Client: reader, Config: testChainConfig()}}})
	...
	_, slow := quotev1connect.NewQuoteServiceHandler(Handler{Chains: map[string]Chain{"base": {ChainID: "8453", Client: reader, Config: testChainConfig()}}})
	...
	_, partial := quotev1connect.NewQuoteServiceHandler(Handler{Chains: map[string]Chain{"base": {ChainID: "8453", Client: reader, Config: testChainConfig()}}})
